"""
Django settings for time_planner_test_40232 project.
...
ROOT_URLCONF = 'time_planner_test_40232.urls'
...
WSGI_APPLICATION = 'time_planner_test_40232.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "time_planner_test_40232 API",
    "DESCRIPTION": "API documentation for time_planner_test_40232 App",
    "VERSION": "v1",
}
